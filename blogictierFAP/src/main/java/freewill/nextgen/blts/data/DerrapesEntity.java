...
@Entity
@Table(name = "DERRAPESENTITY")
@EntityListeners(BltAuditingEntityListener.class)
public class DerrapesEntity implements Serializable, Cloneable {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof DerrapesEntity && obj.getClass().equals(getClass())) {
			return this.id.equals(((DerrapesEntity) obj).id);
		}
	...
	@Override
	public DerrapesEntity clone() throws CloneNotSupportedException {
		return (DerrapesEntity) super.clone();
	}
