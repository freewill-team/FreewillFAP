...
/**
 * Session Bean implementation class Battle Rondas
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "BATTLERONDAENTITY")
@EntityListeners(BltAuditingEntityListener.class)
public class BattleRondaEntity implements Serializable, Cloneable {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof BattleRondaEntity && obj.getClass().equals(getClass())) {
			return this.id.equals(((BattleRondaEntity) obj).id);
		}
	...
	@Override
	public BattleRondaEntity clone() throws CloneNotSupportedException {
		return (BattleRondaEntity) super.clone();
	}
