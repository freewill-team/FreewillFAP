...
public class LoginScreen extends CssLayout {
    ...
    /*private Component buildNewPasswordForm() {
        ...
        Label resultado = new Label("Done. Please check your e-mail.");
        ...
        login.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                try {
                	...
                	boolean res = DataService.get().resetPassword(username.getValue());
                	if(res==true){
                		showNotification(new Notification("A new Password has been requested. Please check your e-mail.",
                			Notification.Type.HUMANIZED_MESSAGE));
                		resultado.setVisible(true);
                	}
                	else{
                		showNotification(new Notification("Error. Problem when sending e-mail notification.",
