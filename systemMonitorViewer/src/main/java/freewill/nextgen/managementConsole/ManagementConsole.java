...
public class ManagementConsole {
	...
	private static String PROCESSID = "ManagementConsole";			// Process Name
    ...
    public static void main(String[] args) throws LifecycleException {
    	...
    	int tomcatPort = service.readConfigPropInt("TomcatPort", 8888);
		...
		try {
    		...
    		while(service.getProcess().getStopProcess()==false) // near-Infinite loop
    		{
    			...
    			// It does nothing else, as all the work is done by the Tomcat
