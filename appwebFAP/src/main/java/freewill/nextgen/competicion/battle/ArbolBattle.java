...
public class ArbolBattle extends Panel {
	...
	public ArbolBattle(EliminatoriaEnum levels, ClickListener action){
	...
	public void setRecords(List<BattleRondaEntity> records) {
        for(BattleRondaEntity rec:records){
        	System.out.println("BattleRondaEntity="+rec);
