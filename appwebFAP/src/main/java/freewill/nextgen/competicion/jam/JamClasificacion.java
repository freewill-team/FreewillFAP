...
public class JamClasificacion extends VerticalLayout {
	...
	private JamShowEntity selectedRec = null;
	private boolean existeKO = false;

	public JamClasificacion(Long categoria, String labelcategoria, Long competicion, 
            ...
            public void buttonClick(ClickEvent event) {
            	...
            	if(existeKO==true){
            		...
            		ConfirmDialog cd = new ConfirmDialog(
            				"Esta acción creará la final de Jam\n" +
