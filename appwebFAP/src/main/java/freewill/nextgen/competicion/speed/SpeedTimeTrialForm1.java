...
public class SpeedTimeTrialForm1 extends SpeedTimeTrialFormDesign1 {
    ...
    public SpeedTimeTrialForm1(SpeedCrudLogic logic) {
        super();
        addStyleName("product-form");
        this.viewLogic = logic;
        
        tiempo1A.setRequired(true);
        tiempo1B.setRequired(true);
        conos1.setRequired(true);
        tiempoAjustado1.setRequired(false);
        
        int numConos = EntryPoint.get().getConfigInt(ConfigItemEnum.MAXNUMCONOSDERRIBADOS);
        for(int i=0;i<=numConos;i++)
        	conos1.addItem(i);
        conos1.setItemCaption(numConos, "Nulo");
        ...
        fieldGroup.addCommitHandler(new CommitHandler() {
            ...
            public void postCommit(CommitEvent commitEvent)
            	...
            	if(viewLogic!=null){
            		viewLogic.saveRecordTiempo(rec, RondaEnum.PRIMERA);
            	}
            }
        });
    ...
    private void formHasChanged() {
        ...
        tiempoAjustado1.setEnabled(false);
