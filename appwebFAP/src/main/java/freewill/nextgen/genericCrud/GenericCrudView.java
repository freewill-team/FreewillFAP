...
public class GenericCrudView<T> extends CssLayout implements View {
    ...
    private Class<? extends CustomFormInterface<T>> iclassForm = null;
	...
	public HorizontalLayout createTopBar(Class<T> entity, String idfield, String... fields) {
		...
		exportBtn.setVisible(EntryPoint.get().getAccessControl().isUserInRole(UserRoleEnum.COORD));
    ...
    public void enter(ViewChangeEvent event) {
    	...
    	try{
	    	if(iclassForm!=null){
	    		if(iform!=null)
	    			removeComponent(iform.getComponent());
	    		iform = iclassForm.newInstance();
	    		iform.setLogic(viewLogic);
	    		addComponent(iform.getComponent());
	    	}
	    	viewLogic.init();
    ...
    public GenericCrudView(String permission, String viewkey, 
    		Class<? extends CustomFormInterface<T>> classForm, 
    		Class<T> entity, String idfield, String... fields) {
        ...
        // iform.setLogic(viewLogic); ahora se hace en enter()
        ...
        addComponent(barAndGridLayout);
        //addComponent(iform.getComponent()); ahora se hace en enter()
