...
public class SelectPatinadorDialog extends Window {
	private boolean isOK = false;
	private Button save = null;
	private PatinadorEntity selected = null;
	private GenericGrid<PatinadorEntity> grid = null;
	
	public PatinadorEntity getSelected(){
		return selected;
	}
    ...
    public SelectPatinadorDialog(Collection<PatinadorEntity> students) {
    	setCaption("<b>Por favor, seleccione un patinador:</b>");
    ...
    private Component buildContent(Collection<PatinadorEntity> students) {
        VerticalLayout result = new VerticalLayout();
        result.setMargin(true);
        result.setSpacing(true);
        
        grid = new GenericGrid<PatinadorEntity>(PatinadorEntity.class, "id", "nombre", "apellidos", "clubStr");
        ...
        /*try{
        	GenericCrudLogic<PatinadorEntity> logic = 
        		new GenericCrudLogic<PatinadorEntity>(null, PatinadorEntity.class, "id");
        	grid.setRecords(logic.getRecords());
        }
        catch(Exception e){
        	e.printStackTrace();
