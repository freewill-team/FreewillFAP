...
public class EventSummary extends CssLayout implements View {
    ...
    public final String VIEW_NAME = Messages.get().getKey("eventcrudview.viewname");
	...
	public HorizontalLayout createTopBar() {
		...
		exportBtn.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
				File file = ExportToXls.get().createXLS((List<EventEntity>)grid.getContainerDataSource().getItemIds(),
