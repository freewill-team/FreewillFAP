...
public class ProjectLoadImage extends Window {

    private Image image = null;
    private ProjectForm parent = null;
    private File tempFile = null;

    public ProjectLoadImage(ProjectForm prnt) {
    	parent = prnt;
        setCaption("Upload Logo");
        setModal(true);
        setClosable(false);
        setResizable(false);
	...
	private Component buildFooter() {
        ...
        upload.addListener(new Upload.StartedListener(){
			...
			public void uploadStarted(StartedEvent event) {
				...
				long maxsize = EntryPoint.get().getConfigLong("upload.max.image");
				if(size>maxsize){
