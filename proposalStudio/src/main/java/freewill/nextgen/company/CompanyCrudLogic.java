...
public class CompanyCrudLogic implements CrudLogicInterface<CompanyEntity> /*Serializable*/ {

    private /*CompanyCrudView*/ CrudViewInterface<CompanyEntity> view;

	public CompanyCrudLogic(/*CompanyCrudView*/ CrudViewInterface<CompanyEntity> simpleCrudView) {
        view = simpleCrudView;
    }
    ...
    public void saveRecord(CompanyEntity rec, boolean saveAndNext) {
        try {
