package fwt.apppubfap.authentication;
...
public class AccessControl {
    ...
    public boolean signIn(String username, String password, String console) {
        ...
        try{
	    	...
	    	String tokenKey = BltClient.get().askForToken(username, digestedPassword, "RealtimeFAP");
	        ...
	        RtdbDataService.get().pushEvent(new EventEntity(
    				new Date(), 
    				String.format(AlarmDic.ALM0021.toString(), username, "ApppubFAP"),
    				username,
    		...
    		RtdbDataService.get().pushEvent(new EventEntity(
    				new Date(), 
    				String.format(AlarmDic.ALM0022.toString(), username, "ApppubFAP"),
    				username,
    				ADMSservice.HMI.toString(), // ParentPoint
    				"ApppubFAP", // PointType
